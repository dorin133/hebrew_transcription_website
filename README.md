...
A web page with three buttons that runs transcription on your own computer.
...
2. **Download Model** — downloads `ivrit-ai/whisper-large-v3`. Several GB, once; reused offline afterwards.
